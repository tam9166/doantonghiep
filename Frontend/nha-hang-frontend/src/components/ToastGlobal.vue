...
.toast-success { background: rgba(90, 110, 69, 0.12); border-color: rgba(90, 110, 69, 0.25); }
.toast-error { background: rgba(178, 59, 46, 0.12); border-color: rgba(178, 59, 46, 0.25); }
.toast-warning { background: rgba(185, 130, 41, 0.12); border-color: rgba(185, 130, 41, 0.25); }
.toast-info { background: rgba(90, 110, 69, 0.12); border-color: rgba(90, 110, 69, 0.25); }
