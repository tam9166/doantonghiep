...
.toast-success { background: rgba(0, 212, 170, 0.12); border-color: rgba(0, 212, 170, 0.25); }
.toast-error { background: rgba(231, 76, 60, 0.12); border-color: rgba(231, 76, 60, 0.25); }
.toast-warning { background: rgba(241, 196, 15, 0.12); border-color: rgba(241, 196, 15, 0.25); }
.toast-info { background: rgba(52, 152, 219, 0.12); border-color: rgba(52, 152, 219, 0.25); }

.toast-icon { font-size: 1.3rem; flex-shrink: 0; margin-top: 2px; }
.toast-body { flex: 1; min-width: 0; }
.toast-title { margin: 0 0 4px 0; font-weight: 800; font-size: 0.92rem; color: #fff; }
