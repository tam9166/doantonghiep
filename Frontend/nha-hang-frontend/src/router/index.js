...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/admin/products', name: 'admin-products', component: () => import('@/views/AdminProduct.vue') },
    ...
    { path: '/admin/kitchen-proposals', name: 'AdminKitchenProposals', component: () => import('../views/AdminKitchenProposals.vue') },
    ...
    { path: '/kitchen/inventory', name: 'KitchenInventory', component: () => import('../views/Kitchen.vue') },
