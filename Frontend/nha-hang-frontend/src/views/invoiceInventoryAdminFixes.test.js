...
describe('invoice, inventory and admin UI regression contracts', () => {
  ...
  it('requires actual purchase data and aggregates batch approval', () => {
    ...
    expect(purchase).toContain('previous-price-box')
    expect(purchase).toContain('line-remove-btn')
    expect(purchase).toContain('inputmode="decimal"')
    expect(purchase).toContain('approvalError')
    expect(purchase).toContain('batchError')
    expect(purchase).toContain('normalizeDecimalInput')
    expect(purchase).toContain('parseDecimalInput')
    expect(purchase).toContain('decimalPayload')
    ...
    expect(purchase).toContain('Nhập kho thành công.')
