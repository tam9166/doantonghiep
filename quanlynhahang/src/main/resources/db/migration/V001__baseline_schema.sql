...
BEGIN
    CREATE TABLE dbo.reservation_waitlist (
        ...
        created_at DATETIME2 NOT NULL CONSTRAINT df_reservation_waitlist_created_at DEFAULT SYSDATETIME(),
        updated_at DATETIME2 NOT NULL CONSTRAINT df_reservation_waitlist_updated_at DEFAULT SYSDATETIME(),
        CONSTRAINT fk_reservation_waitlist_area FOREIGN KEY (area_id) REFERENCES dbo.table_areas(id)
    );
END;
